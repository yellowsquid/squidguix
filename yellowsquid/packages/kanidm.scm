    ...
    (arguments
     `(#:install-source? #f
       ...
       #:cargo-inputs (("rust-anyhow" ,rust-anyhow-1)
                       ...
                       ("rust-futures-concurrency" ,rust-futures-concurrency-3)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0cyp22wy0lykpmkikkr7z0c0rg6j7cw2xpphd83vav5rr44ymrhb"))))
    (build-system cargo-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0dkyhcy0szfgm49r5hdivxv2kz3jl6c4z6jbvb4d19ii203d8dy9"))))
    (build-system cargo-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "1vgz0ssjdz2gvxvz0ghzndpfj4idfkvqazl8vy5346mj2ajrndw5"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-anstream" ,rust-anstream-0.6)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "1s7la71v10m4hnsikdfm7g0q54fzb6ixpw0dgd1862fgldnmjg5a"))))
    (build-system cargo-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0jpd7rcz7yww3smdpm22wsnpvwdvxw27rzhjzqqfliwcnj8sld9n"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "1xarm1kc76mr3zn6h50dn9iaqnd33hi4w335y75sv62l26l909bk"))))
    (build-system cargo-build-system)
    (arguments
...
(define-public rust-csv-1
  (package
    ...
    (description
     "This package provides Fast CSV parsing with support for serde.")
...
(define-public rust-dyn-clone-1
  (package
    ...
    (description "This package provides Clone trait that is object-safe.")
    (license (list license:expat license:asl2.0))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0aj6v01v6mn0i7lqihycf1w9s306z9v5if47wbxwainn2p03j4c7"))))
    (build-system cargo-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "1c04g14bccmprwsvx2j9m2blhwrynq7vhl151lsvcv4gi0b6jp34"))))
    (build-system cargo-build-system)
    (arguments
...
(define-public rust-gloo-timers-0.3
  (package
    ...
    (description
     "This package provides Convenience crate for working with @code{JavaScript} timers.")
    (license (list license:expat license:asl2.0))))
...
(define-public rust-hex-0.4
  (package
    ...
    (arguments
     `(#:cargo-inputs (("rust-serde" ,rust-serde-1))
       #:cargo-development-inputs (("rust-criterion" ,rust-criterion-0.3)
                                   ("rust-faster-hex" ,rust-faster-hex-0.5)
    ...
    (description
     "This package provides Encoding and decoding data into/from hexadecimal representation.")
    (license (list license:expat license:asl2.0))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "01ds8i3q6hw5kw56mavy544m11gkr87zi999siigdl3n1qpd5psh"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs (("rust-bytes" ,rust-bytes-1)
                       ("rust-futures-channel" ,rust-futures-channel-0.3)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "1fg9h591skksq5zxnffyisj7487jhdcgj6c7bvlkckn535bhbryd"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs (("rust-bytes" ,rust-bytes-1)
                       ("rust-futures-channel" ,rust-futures-channel-0.3)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "170sjc69iz1sz8dh1pzcsfffhlbjjc6kb9cwxfy161n20p32xp54"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs (("rust-base64" ,rust-base64-0.21)
                       ("rust-base64urlsafedata" ,rust-base64urlsafedata-0.5)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "1zn0zpfjk9vjf79dsbfpq7p129km4g83vnvsc61y8qc6g7afnv2j"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-base64" ,rust-base64-0.21)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0kzcyz0i90ni2fbgldbb2dp4s0d8hrb93zycq7i2vcnsl9p1w5iz"))))
    (build-system cargo-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "017rzh4kyl3j79sj0qc35wallblsqbnkzxpn6i3xkrv02y4kkvip"))))
    (build-system cargo-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "1hfr9ffx67j455aqrmyys3c8l65ngbqrl5qi3v3fi8vhddwg8acm"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs (("rust-bitflags" ,rust-bitflags-2)
                       ("rust-cfg-if" ,rust-cfg-if-1)
  ...
  (package
    ...
    (arguments
     `(#:cargo-inputs (("rust-async-compression" ,rust-async-compression-0.4)
                       ...
                       ("rust-h2" ,rust-h2-0.4)
                       ("rust-h3" ,rust-h3-0.0.5)
                       ("rust-h3-quinn" ,rust-h3-quinn-0.0.6)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0w9g1dr00mhcqp02407059h40rsksngzkn26p2br00ll6r3ax1hg"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-bytemuck" ,rust-bytemuck-1)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0plb1g2q2yc9x1spw0iwhga2q7iql4w99d7da1fd434037wxcij6"))))
    (build-system cargo-build-system)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "133n9lnlmcsayscz3ajk74dpp0pm4jygvf6ln0gmnil4cpk9imgy"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs (("rust-bitflags" ,rust-bitflags-2)
                       ("rust-libc" ,rust-libc-0.2)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0l5ivyrj2b5lcmhzdw6h8g6bpb1zarai8y91ghmsap8klyqysfp3"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "1h902hk53x4lqg95i47d9bk229r0cb331nvlcwfic802r5d6ybb9"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-proc-macro2" ,rust-proc-macro2-1)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0mxqyh2qzq5xi8pnv9647337pz107yjv3ck7x9b229s892lwzkk9"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs (("rust-base64" ,rust-base64-0.22)
                       ("rust-chrono" ,rust-chrono-0.4)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0l1kfkzj46can1rwfspmnan8shqr0prlmbaig9hp9wpl3scy9zm8"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
including SHA-224, SHA-256, SHA-384, and SHA-512.")
    (description
     "This package provides Pure Rust implementation of the SHA-2 hash function family including SHA-224,
...
(define-public rust-shellexpand-2
  (package
    ...
    (description "This package provides Shell-like expansions in strings.")
    (license (list license:expat license:asl2.0))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0gfnskg4fgpmv3j2q7lvax6c4wqq151zf7vzynngc9vpysfvgykg"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs (("rust-futures-util" ,rust-futures-util-0.3)
                       ("rust-openssl" ,rust-openssl-0.10)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "1qcz30db6m8lxkl61b3nic4bim1symi636nhbb3rmi3i6xxv9xlw"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs (("rust-bytes" ,rust-bytes-1)
                       ("rust-futures-core" ,rust-futures-core-0.3)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0d2266nx8b3n22c7k24x4428z6di8n83a9n466jm7a2hipfz1xzl"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs (("rust-indexmap" ,rust-indexmap-1)
                       ("rust-serde" ,rust-serde-1))
...
(define-public rust-tracing-0.1
  (package
    ...
    (description "This package provides Application-level tracing for Rust.")
    (license license:expat)))
...
(define-public rust-walkdir-2
  (package
    ...
    (description "This package provides Recursively walk a directory.")
    (license (list license:unlicense license:expat))))
  ...
  (package
    ...
    (arguments
     `(#:cargo-inputs (("rust-arbitrary" ,rust-arbitrary-1)
       ...
       #:cargo-development-inputs (("rust-ecdsa" ,rust-ecdsa-0.16)
                                   ("rust-hex-literal" ,rust-hex-literal-0.4)
                                   ("rust-p256" ,rust-p256-0.13)
                                   ("rust-rand" ,rust-rand-0.8)
                                   ("rust-rsa" ,rust-rsa-0.9)
...
format as described in RFC 5280")
    (description
     "This package provides Pure Rust implementation of the X.509 Public Key Infrastructure Certificate
format as described in RFC 5280.")
    (license (list license:asl2.0 license:expat))))
