  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "066045x0j48n27qsmravpqw9x8phpcwhcl0xb961m75wrl0bwlbp"))
    ...
    (native-inputs (list autoconf automake libtool perl-test-warnings
                         perl-test-mockmodule))
    (inputs (list inetutils ;logger
                  net-tools
    ...
    (description
     "This package provides a client to update dynamic IP
